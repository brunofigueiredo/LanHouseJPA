 ...
 */
public class ListarAutomovelGUI extends javax.swing.JFrame {
    private MarcaTableModel modelo;
    /**
     * Creates new form ListarMarcaGUI
     */
    public ListarAutomovelGUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tabMarca.getColumnModel().getColumn(0).setPreferredWidth(50);
        tabMarca.getColumnModel().getColumn(1).setPreferredWidth(70);
        tabMarca.getColumnModel().getColumn(2).setPreferredWidth(70);
        tabMarca.getColumnModel().getColumn(3).setPreferredWidth(70);
